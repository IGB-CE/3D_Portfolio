...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('SERVICE', import.meta.env.VITE_EMAILJS_APP_SERVICE_ID);
        console.log('TEMPLATE', import.meta.env.VITE_EMAILJS_APP_TEMPLATE_ID);
        console.log('PUBLIC KEY', import.meta.env.VITE_EMAILJS_APP_PUBLIC_KEY);
